 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ng;function Ly(){if(ng)return _e;ng=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),h=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),y=Symbol.iterator;function S(C){return C===null||typeof C!="object"?null:(C=y&&C[y]||C["@@iterator"],typeof C=="function"?C:null)}var M={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},A=Object.assign,R={};function v(C,Q,pt){this.props=C,this.context=Q,this.refs=R,this.updater=pt||M}v.prototype.isReactComponent={},v.prototype.setState=function(C,Q){if(typeof C!="object"&&typeof C!="function"&&C!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,C,Q,"setState")},v.prototype.forceUpdate=function(C){this.updater.enqueueForceUpdate(this,C,"forceUpdate")};function _(){}_.prototype=v.prototype;function P(C,Q,pt){this.props=C,this.context=Q,this.refs=R,this.updater=pt||M}var D=P.prototype=new _;D.constructor=P,A(D,v.prototype),D.isPureReactComponent=!0;var F=Array.isArray,X={H:null,A:null,T:null,S:null},W=Object.prototype.hasOwnProperty;function I(C,Q,pt,Dt,j,ht){return pt=ht.ref,{$$typeof:o,type:C,key:Q,ref:pt!==void 0?pt:null,props:ht}}function _t(C,Q){return I(C.type,Q,void 0,void 0,void 0,C.props)}function z(C){return typeof C=="object"&&C!==null&&C.$$typeof===o}function E(C){var Q={"=":"=0",":":"=2"};return"$"+C.replace(/[=:]/g,function(pt){return Q[pt]})}var N=/\/+/g;function gt(C,Q){return typeof C=="object"&&C!==null&&C.key!=null?E(""+C.key):Q.toString(36)}function wt(){}function J(C){switch(C.status){case"fulfilled":return C.value;case"rejected":throw C.reason;default:switch(typeof C.status=="string"?C.then(wt,wt):(C.status="pending",C.then(function(Q){C.status==="pending"&&(C.status="fulfilled",C.value=Q)},function(Q){C.status==="pending"&&(C.status="rejected",C.reason=Q)})),C.status){case"fulfilled":return C.value;case"rejected":throw C.reason}}throw C}function ct(C,Q,pt,Dt,j){var ht=typeof C;(ht==="undefined"||ht==="boolean")&&(C=null);var bt=!1;if(C===null)bt=!0;else switch(ht){case"bigint":case"string":case"number":bt=!0;break;case"object":switch(C.$$typeof){case o:case e:bt=!0;break;case g:return bt=C._init,ct(bt(C._payload),Q,pt,Dt,j)}}if(bt)return j=j(C),bt=Dt===""?"."+gt(C,0):Dt,F(j)?(pt="",bt!=null&&(pt=bt.replace(N,"$&/")+"/"),ct(j,Q,pt,"",function(Gt){return Gt})):j!=null&&(z(j)&&(j=_t(j,pt+(j.key==null||C&&C.key===j.key?"":(""+j.key).replace(N,"$&/")+"/")+bt)),Q.push(j)),1;bt=0;var Yt=Dt===""?".":Dt+":";if(F(C))for(var Ht=0;Ht<C.length;Ht++)Dt=C[Ht],ht=Yt+gt(Dt,Ht),bt+=ct(Dt,Q,pt,ht,j);else if(Ht=S(C),typeof Ht=="function")for(C=Ht.call(C),Ht=0;!(Dt=C.next()).done;)Dt=Dt.value,ht=Yt+gt(Dt,Ht++),bt+=ct(Dt,Q,pt,ht,j);else if(ht==="object"){if(typeof C.then=="function")return ct(J(C),Q,pt,Dt,j);throw Q=String(C),Error("Objects are not valid as a React child (found: "+(Q==="[object Object]"?"object with keys {"+Object.keys(C).join(", ")+"}":Q)+"). If you meant to render a collection of children, use an array instead.")}return bt}function V(C,Q,pt){if(C==null)return C;var Dt=[],j=0;return ct(C,Dt,"","",function(ht){return Q.call(pt,ht,j++)}),Dt}function lt(C){if(C._status===-1){var Q=C._result;Q=Q(),Q.then(function(pt){(C._status===0||C._status===-1)&&(C._status=1,C._result=pt)},function(pt){(C._status===0||C._status===-1)&&(C._status=2,C._result=pt)}),C._status===-1&&(C._status=0,C._result=Q)}if(C._status===1)return C._result.default;throw C._result}var at=typeof reportError=="function"?reportError:function(C){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var Q=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof C=="object"&&C!==null&&typeof C.message=="string"?String(C.message):String(C),error:C});if(!window.dispatchEvent(Q))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",C);return}console.error(C)};function dt(){}return _e.Children={map:V,forEach:function(C,Q,pt){V(C,function(){Q.apply(this,arguments)},pt)},count:function(C){var Q=0;return V(C,function(){Q++}),Q},toArray:function(C){return V(C,function(Q){return Q})||[]},only:function(C){if(!z(C))throw Error("React.Children.only expected to receive a single React element child.");return C}},_e.Component=v,_e.Fragment=i,_e.Profiler=l,_e.PureComponent=P,_e.StrictMode=r,_e.Suspense=p,_e.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=X,_e.act=function(){throw Error("act(...) is not supported in production builds of React.")},_e.cache=function(C){return function(){return C.apply(null,arguments)}},_e.cloneElement=function(C,Q,pt){if(C==null)throw Error("The argument must be a React element, but you passed "+C+".");var Dt=A({},C.props),j=C.key,ht=void 0;if(Q!=null)for(bt in Q.ref!==void 0&&(ht=void 0),Q.key!==void 0&&(j=""+Q.key),Q)!W.call(Q,bt)||bt==="key"||bt==="__self"||bt==="__source"||bt==="ref"&&Q.ref===void 0||(Dt[bt]=Q[bt]);var bt=arguments.length-2;if(bt===1)Dt.children=pt;else if(1<bt){for(var Yt=Array(bt),Ht=0;Ht<bt;Ht++)Yt[Ht]=arguments[Ht+2];Dt.children=Yt}return I(C.type,j,void 0,void 0,ht,Dt)},_e.createContext=function(C){return C={$$typeof:h,_currentValue:C,_currentValue2:C,_threadCount:0,Provider:null,Consumer:null},C.Provider=C,C.Consumer={$$typeof:u,_context:C},C},_e.createElement=function(C,Q,pt){var Dt,j={},ht=null;if(Q!=null)for(Dt in Q.key!==void 0&&(ht=""+Q.key),Q)W.call(Q,Dt)&&Dt!=="key"&&Dt!=="__self"&&Dt!=="__source"&&(j[Dt]=Q[Dt]);var bt=arguments.length-2;if(bt===1)j.children=pt;else if(1<bt){for(var Yt=Array(bt),Ht=0;Ht<bt;Ht++)Yt[Ht]=arguments[Ht+2];j.children=Yt}if(C&&C.defaultProps)for(Dt in bt=C.defaultProps,bt)j[Dt]===void 0&&(j[Dt]=bt[Dt]);return I(C,ht,void 0,void 0,null,j)},_e.createRef=function(){return{current:null}},_e.forwardRef=function(C){return{$$typeof:d,render:C}},_e.isValidElement=z,_e.lazy=function(C){return{$$typeof:g,_payload:{_status:-1,_result:C},_init:lt}},_e.memo=function(C,Q){return{$$typeof:m,type:C,compare:Q===void 0?null:Q}},_e.startTransition=function(C){var Q=X.T,pt={};X.T=pt;try{var Dt=C(),j=X.S;j!==null&&j(pt,Dt),typeof Dt=="object"&&Dt!==null&&typeof Dt.then=="function"&&Dt.then(dt,at)}catch(ht){at(ht)}finally{X.T=Q}},_e.unstable_useCacheRefresh=function(){return X.H.useCacheRefresh()},_e.use=function(C){return X.H.use(C)},_e.useActionState=function(C,Q,pt){return X.H.useActionState(C,Q,pt)},_e.useCallback=function(C,Q){return X.H.useCallback(C,Q)},_e.useContext=function(C){return X.H.useContext(C)},_e.useDebugValue=function(){},_e.useDeferredValue=function(C,Q){return X.H.useDeferredValue(C,Q)},_e.useEffect=function(C,Q){return X.H.useEffect(C,Q)},_e.useId=function(){return X.H.useId()},_e.useImperativeHandle=function(C,Q,pt){return X.H.useImperativeHandle(C,Q,pt)},_e.useInsertionEffect=function(C,Q){return X.H.useInsertionEffect(C,Q)},_e.useLayoutEffect=function(C,Q){return X.H.useLayoutEffect(C,Q)},_e.useMemo=function(C,Q){return X.H.useMemo(C,Q)},_e.useOptimistic=function(C,Q){return X.H.useOptimistic(C,Q)},_e.useReducer=function(C,Q,pt){return X.H.useReducer(C,Q,pt)},_e.useRef=function(C){return X.H.useRef(C)},_e.useState=function(C){return X.H.useState(C)},_e.useSyncExternalStore=function(C,Q,pt){return X.H.useSyncExternalStore(C,Q,pt)},_e.useTransition=function(){return X.H.useTransition()},_e.version="19.0.0",_e}var ig;function Ad(){return ig||(ig=1,Uf.exports=Ly()),Uf.exports}var de=Ad(),Nf={exports:{}},Ro={},Of={exports:{}},Pf={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var lg;function zy(){if(lg)return Ro;lg=1;var o=Ny(),e=Ad(),i=Py();function r(t){var n="https://react.dev/errors/"+t;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+t+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function l(t){return!(!t||t.nodeType!==1&&t.nodeType!==9&&t.nodeType!==11)}var u=Symbol.for("react.element"),h=Symbol.for("react.transitional.element"),d=Symbol.for("react.portal"),p=Symbol.for("react.fragment"),m=Symbol.for("react.strict_mode"),g=Symbol.for("react.profiler"),y=Symbol.for("react.provider"),S=Symbol.for("react.consumer"),M=Symbol.for("react.context"),A=Symbol.for("react.forward_ref"),R=Symbol.for("react.suspense"),v=Symbol.for("react.suspense_list"),_=Symbol.for("react.memo"),P=Symbol.for("react.lazy"),D=Symbol.for("react.offscreen"),F=Symbol.for("react.memo_cache_sentinel"),X=Symbol.iterator;function W(t){return t===null||typeof t!="object"?null:(t=X&&t[X]||t["@@iterator"],typeof t=="function"?t:null)}var I=Symbol.for("react.client.reference");function _t(t){if(t==null)return null;if(typeof t=="function")return t.$$typeof===I?null:t.displayName||t.name||null;if(typeof t=="string")return t;switch(t){case p:return"Fragment";case d:return"Portal";case g:return"Profiler";case m:return"StrictMode";case R:return"Suspense";case v:return"SuspenseList"}if(typeof t=="object")switch(t.$$typeof){case M:return(t.displayName||"Context")+".Provider";case S:return(t._context.displayName||"Context")+".Consumer";case A:var n=t.render;return t=t.displayName,t||(t=n.displayName||n.name||"",t=t!==""?"ForwardRef("+t+")":"ForwardRef"),t;case _:return n=t.displayName||null,n!==null?n:_t(t.type)||"Memo";case P:n=t._payload,t=t._init;try{return _t(t(n))}catch{}}return null}var z=e.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,E=Object.assign,N,gt;function wt(t){if(N===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);N=n&&n[1]||"",gt=-1<a.stack.indexOf(`
    at`)?" (<anonymous>)":-1<a.stack.indexOf("@")?"@unknown:0:0":""}return`
`+N+t+gt}var J=!1;function ct(t,n){if(!t||J)return"";J=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var s={DetermineComponentFrameRoot:function(){try{if(n){var Ct=function(){throw Error()};if(Object.defineProperty(Ct.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(Ct,[])}catch(vt){var ut=vt}Reflect.construct(t,[],Ct)}else{try{Ct.call()}catch(vt){ut=vt}t.call(Ct.prototype)}}else{try{throw Error()}catch(vt){ut=vt}(Ct=t())&&typeof Ct.catch=="function"&&Ct.catch(function(){})}}catch(vt){if(vt&&ut&&typeof vt.stack=="string")return[vt.stack,ut.stack]}return[null,null]}};s.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var c=Object.getOwnPropertyDescriptor(s.DetermineComponentFrameRoot,"name");c&&c.configurable&&Object.defineProperty(s.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var f=s.DetermineComponentFrameRoot(),x=f[0],w=f[1];if(x&&w){var B=x.split(`
`),$=w.split(`
...
`)+`
`+P);const F=D+_+h,X=D+P+d,W=M_(l,l.VERTEX_SHADER,F),I=M_(l,l.FRAGMENT_SHADER,X);l.attachShader(v,W),l.attachShader(v,I),i.index0AttributeName!==void 0?l.bindAttribLocation(v,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(v,0,"position"),l.linkProgram(v);function _t(gt){if(o.debug.checkShaderErrors){const wt=l.getProgramInfoLog(v).trim(),J=l.getShaderInfoLog(W).trim(),ct=l.getShaderInfoLog(I).trim();let V=!0,lt=!0;if(l.getProgramParameter(v,l.LINK_STATUS)===!1)if(V=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,v,W,I);else{const at=E_(l,W,"vertex"),dt=E_(l,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(v,l.VALIDATE_STATUS)+`
...
}`;function qb(o,e,i){let r=new Ud;const l=new pe,u=new pe,h=new Ke,d=new Vb({depthPacking:wx}),p=new kb,m={},g=i.maxTextureSize,y={[Wa]:kn,[kn]:Wa,[Pi]:Pi},S=new ca({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new pe},radius:{value:4}},vertexShader:Wb,fragmentShader:Xb}),M=S.clone();M.defines.HORIZONTAL_PASS=1;const A=new Fi;A.setAttribute("position",new Bi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const R=new $n(A,S),v=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=k_;let _=this.type;this.render=function(W,I,_t){if(v.enabled===!1||v.autoUpdate===!1&&v.needsUpdate===!1||W.length===0)return;const z=o.getRenderTarget(),E=o.getActiveCubeFace(),N=o.getActiveMipmapLevel(),gt=o.state;gt.setBlending(Ha),gt.buffers.color.setClear(1,1,1,1),gt.buffers.depth.setTest(!0),gt.setScissorTest(!1);const wt=_!==ra&&this.type===ra,J=_===ra&&this.type!==ra;for(let ct=0,V=W.length;ct<V;ct++){const lt=W[ct],at=lt.shadow;if(at===void 0){console.warn("THREE.WebGLShadowMap:",lt,"has no shadow.");continue}if(at.autoUpdate===!1&&at.needsUpdate===!1)continue;l.copy(at.mapSize);const dt=at.getFrameExtents();if(l.multiply(dt),u.copy(at.mapSize),(l.x>g||l.y>g)&&(l.x>g&&(u.x=Math.floor(g/dt.x),l.x=u.x*dt.x,at.mapSize.x=u.x),l.y>g&&(u.y=Math.floor(g/dt.y),l.y=u.y*dt.y,at.mapSize.y=u.y)),at.map===null||wt===!0||J===!0){const Q=this.type!==ra?{minFilter:Fn,magFilter:Fn}:{};at.map!==null&&at.map.dispose(),at.map=new Sr(l.x,l.y,Q),at.map.texture.name=lt.name+".shadowMap",at.camera.updateProjectionMatrix()}o.setRenderTarget(at.map),o.clear();const C=at.getViewportCount();for(let Q=0;Q<C;Q++){const pt=at.getViewport(Q);h.set(u.x*pt.x,u.y*pt.y,u.x*pt.z,u.y*pt.w),gt.viewport(h),at.updateMatrices(lt,Q),r=at.getFrustum(),F(I,_t,at.camera,lt,this.type)}at.isPointLightShadow!==!0&&this.type===ra&&P(at,_t),at.needsUpdate=!1}_=this.type,v.needsUpdate=!1,o.setRenderTarget(z,E,N)};function P(W,I){const _t=e.update(R);S.defines.VSM_SAMPLES!==W.blurSamples&&(S.defines.VSM_SAMPLES=W.blurSamples,M.defines.VSM_SAMPLES=W.blurSamples,S.needsUpdate=!0,M.needsUpdate=!0),W.mapPass===null&&(W.mapPass=new Sr(l.x,l.y)),S.uniforms.shadow_pass.value=W.map.texture,S.uniforms.resolution.value=W.mapSize,S.uniforms.radius.value=W.radius,o.setRenderTarget(W.mapPass),o.clear(),o.renderBufferDirect(I,null,_t,S,R,null),M.uniforms.shadow_pass.value=W.mapPass.texture,M.uniforms.resolution.value=W.mapSize,M.uniforms.radius.value=W.radius,o.setRenderTarget(W.map),o.clear(),o.renderBufferDirect(I,null,_t,M,R,null)}function D(W,I,_t,z){let E=null;const N=_t.isPointLight===!0?W.customDistanceMaterial:W.customDepthMaterial;if(N!==void 0)E=N;else if(E=_t.isPointLight===!0?p:d,o.localClippingEnabled&&I.clipShadows===!0&&Array.isArray(I.clippingPlanes)&&I.clippingPlanes.length!==0||I.displacementMap&&I.displacementScale!==0||I.alphaMap&&I.alphaTest>0||I.map&&I.alphaTest>0){const gt=E.uuid,wt=I.uuid;let J=m[gt];J===void 0&&(J={},m[gt]=J);let ct=J[wt];ct===void 0&&(ct=E.clone(),J[wt]=ct,I.addEventListener("dispose",X)),E=ct}if(E.visible=I.visible,E.wireframe=I.wireframe,z===ra?E.side=I.shadowSide!==null?I.shadowSide:I.side:E.side=I.shadowSide!==null?I.shadowSide:y[I.side],E.alphaMap=I.alphaMap,E.alphaTest=I.alphaTest,E.map=I.map,E.clipShadows=I.clipShadows,E.clippingPlanes=I.clippingPlanes,E.clipIntersection=I.clipIntersection,E.displacementMap=I.displacementMap,E.displacementScale=I.displacementScale,E.displacementBias=I.displacementBias,E.wireframeLinewidth=I.wireframeLinewidth,E.linewidth=I.linewidth,_t.isPointLight===!0&&E.isMeshDistanceMaterial===!0){const gt=o.properties.get(E);gt.light=_t}return E}function F(W,I,_t,z,E){if(W.visible===!1)return;if(W.layers.test(I.layers)&&(W.isMesh||W.isLine||W.isPoints)&&(W.castShadow||W.receiveShadow&&E===ra)&&(!W.frustumCulled||r.intersectsObject(W))){W.modelViewMatrix.multiplyMatrices(_t.matrixWorldInverse,W.matrixWorld);const wt=e.update(W),J=W.material;if(Array.isArray(J)){const ct=wt.groups;for(let V=0,lt=ct.length;V<lt;V++){const at=ct[V],dt=J[at.materialIndex];if(dt&&dt.visible){const C=D(W,dt,z,E);W.onBeforeShadow(o,W,I,_t,wt,C,at),o.renderBufferDirect(_t,null,wt,C,W,at),W.onAfterShadow(o,W,I,_t,wt,C,at)}}}else if(J.visible){const ct=D(W,J,z,E);W.onBeforeShadow(o,W,I,_t,wt,ct,null),o.renderBufferDirect(_t,null,wt,ct,W,null),W.onAfterShadow(o,W,I,_t,wt,ct,null)}}const gt=W.children;for(let wt=0,J=gt.length;wt<J;wt++)F(gt[wt],I,_t,z,E)}function X(W){W.target.removeEventListener("dispose",X);for(const _t in m){const z=m[_t],E=W.target.uuid;E in z&&(z[E].dispose(),delete z[E])}}}function Yb(o,e,i){const r=i.isWebGL2;function l(){let U=!1;const At=new Ke;let Tt=null;const jt=new Ke(0,0,0,0);return{setMask:function(Jt){Tt!==Jt&&!U&&(o.colorMask(Jt,Jt,Jt,Jt),Tt=Jt)},setLocked:function(Jt){U=Jt},setClear:function(Jt,ye,fe,Ae,Xe){Xe===!0&&(Jt*=Ae,ye*=Ae,fe*=Ae),At.set(Jt,ye,fe,Ae),jt.equals(At)===!1&&(o.clearColor(Jt,ye,fe,Ae),jt.copy(At))},reset:function(){U=!1,Tt=null,jt.set(-1,0,0,0)}}}function u(){let U=!1,At=null,Tt=null,jt=null;return{setTest:function(Jt){Jt?Gt(o.DEPTH_TEST):Kt(o.DEPTH_TEST)},setMask:function(Jt){At!==Jt&&!U&&(o.depthMask(Jt),At=Jt)},setFunc:function(Jt){if(Tt!==Jt){switch(Jt){case ix:o.depthFunc(o.NEVER);break;case ax:o.depthFunc(o.ALWAYS);break;case rx:o.depthFunc(o.LESS);break;case mc:o.depthFunc(o.LEQUAL);break;case sx:o.depthFunc(o.EQUAL);break;case ox:o.depthFunc(o.GEQUAL);break;case lx:o.depthFunc(o.GREATER);break;case cx:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}Tt=Jt}},setLocked:function(Jt){U=Jt},setClear:function(Jt){jt!==Jt&&(o.clearDepth(Jt),jt=Jt)},reset:function(){U=!1,At=null,Tt=null,jt=null}}}function h(){let U=!1,At=null,Tt=null,jt=null,Jt=null,ye=null,fe=null,Ae=null,Xe=null;return{setTest:function(oe){U||(oe?Gt(o.STENCIL_TEST):Kt(o.STENCIL_TEST))},setMask:function(oe){At!==oe&&!U&&(o.stencilMask(oe),At=oe)},setFunc:function(oe,we,Pe){(Tt!==oe||jt!==we||Jt!==Pe)&&(o.stencilFunc(oe,we,Pe),Tt=oe,jt=we,Jt=Pe)},setOp:function(oe,we,Pe){(ye!==oe||fe!==we||Ae!==Pe)&&(o.stencilOp(oe,we,Pe),ye=oe,fe=we,Ae=Pe)},setLocked:function(oe){U=oe},setClear:function(oe){Xe!==oe&&(o.clearStencil(oe),Xe=oe)},reset:function(){U=!1,At=null,Tt=null,jt=null,Jt=null,ye=null,fe=null,Ae=null,Xe=null}}}const d=new l,p=new u,m=new h,g=new WeakMap,y=new WeakMap;let S={},M={},A=new WeakMap,R=[],v=null,_=!1,P=null,D=null,F=null,X=null,W=null,I=null,_t=null,z=new Le(0,0,0),E=0,N=!1,gt=null,wt=null,J=null,ct=null,V=null;const lt=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let at=!1,dt=0;const C=o.getParameter(o.VERSION);C.indexOf("WebGL")!==-1?(dt=parseFloat(/^WebGL (\d)/.exec(C)[1]),at=dt>=1):C.indexOf("OpenGL ES")!==-1&&(dt=parseFloat(/^OpenGL ES (\d)/.exec(C)[1]),at=dt>=2);let Q=null,pt={};const Dt=o.getParameter(o.SCISSOR_BOX),j=o.getParameter(o.VIEWPORT),ht=new Ke().fromArray(Dt),bt=new Ke().fromArray(j);function Yt(U,At,Tt,jt){const Jt=new Uint8Array(4),ye=o.createTexture();o.bindTexture(U,ye),o.texParameteri(U,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(U,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let fe=0;fe<Tt;fe++)r&&(U===o.TEXTURE_3D||U===o.TEXTURE_2D_ARRAY)?o.texImage3D(At,0,o.RGBA,1,1,jt,0,o.RGBA,o.UNSIGNED_BYTE,Jt):o.texImage2D(At+fe,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,Jt);return ye}const Ht={};Ht[o.TEXTURE_2D]=Yt(o.TEXTURE_2D,o.TEXTURE_2D,1),Ht[o.TEXTURE_CUBE_MAP]=Yt(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),r&&(Ht[o.TEXTURE_2D_ARRAY]=Yt(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),Ht[o.TEXTURE_3D]=Yt(o.TEXTURE_3D,o.TEXTURE_3D,1,1)),d.setClear(0,0,0,1),p.setClear(1),m.setClear(0),Gt(o.DEPTH_TEST),p.setFunc(mc),ce(!1),L(ug),Gt(o.CULL_FACE),Zt(Ha);function Gt(U){S[U]!==!0&&(o.enable(U),S[U]=!0)}function Kt(U){S[U]!==!1&&(o.disable(U),S[U]=!1)}function ae(U,At){return M[U]!==At?(o.bindFramebuffer(U,At),M[U]=At,r&&(U===o.DRAW_FRAMEBUFFER&&(M[o.FRAMEBUFFER]=At),U===o.FRAMEBUFFER&&(M[o.DRAW_FRAMEBUFFER]=At)),!0):!1}function et(U,At){let Tt=R,jt=!1;if(U)if(Tt=A.get(At),Tt===void 0&&(Tt=[],A.set(At,Tt)),U.isWebGLMultipleRenderTargets){const Jt=U.texture;if(Tt.length!==Jt.length||Tt[0]!==o.COLOR_ATTACHMENT0){for(let ye=0,fe=Jt.length;ye<fe;ye++)Tt[ye]=o.COLOR_ATTACHMENT0+ye;Tt.length=Jt.length,jt=!0}}else Tt[0]!==o.COLOR_ATTACHMENT0&&(Tt[0]=o.COLOR_ATTACHMENT0,jt=!0);else Tt[0]!==o.BACK&&(Tt[0]=o.BACK,jt=!0);jt&&(i.isWebGL2?o.drawBuffers(Tt):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(Tt))}function Oe(U){return v!==U?(o.useProgram(U),v=U,!0):!1}const ne={[mr]:o.FUNC_ADD,[Vy]:o.FUNC_SUBTRACT,[ky]:o.FUNC_REVERSE_SUBTRACT};if(r)ne[hg]=o.MIN,ne[pg]=o.MAX;else{const U=e.get("EXT_blend_minmax");U!==null&&(ne[hg]=U.MIN_EXT,ne[pg]=U.MAX_EXT)}const se={[Wy]:o.ZERO,[Xy]:o.ONE,[qy]:o.SRC_COLOR,[gd]:o.SRC_ALPHA,[Jy]:o.SRC_ALPHA_SATURATE,[Ky]:o.DST_COLOR,[jy]:o.DST_ALPHA,[Yy]:o.ONE_MINUS_SRC_COLOR,[_d]:o.ONE_MINUS_SRC_ALPHA,[Qy]:o.ONE_MINUS_DST_COLOR,[Zy]:o.ONE_MINUS_DST_ALPHA,[$y]:o.CONSTANT_COLOR,[tx]:o.ONE_MINUS_CONSTANT_COLOR,[ex]:o.CONSTANT_ALPHA,[nx]:o.ONE_MINUS_CONSTANT_ALPHA};function Zt(U,At,Tt,jt,Jt,ye,fe,Ae,Xe,oe){if(U===Ha){_===!0&&(Kt(o.BLEND),_=!1);return}if(_===!1&&(Gt(o.BLEND),_=!0),U!==Gy){if(U!==P||oe!==N){if((D!==mr||W!==mr)&&(o.blendEquation(o.FUNC_ADD),D=mr,W=mr),oe)switch(U){case Es:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case md:o.blendFunc(o.ONE,o.ONE);break;case fg:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case dg:o.blendFuncSeparate(o.ZERO,o.SRC_COLOR,o.ZERO,o.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}else switch(U){case Es:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case md:o.blendFunc(o.SRC_ALPHA,o.ONE);break;case fg:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case dg:o.blendFunc(o.ZERO,o.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}F=null,X=null,I=null,_t=null,z.set(0,0,0),E=0,P=U,N=oe}return}Jt=Jt||At,ye=ye||Tt,fe=fe||jt,(At!==D||Jt!==W)&&(o.blendEquationSeparate(ne[At],ne[Jt]),D=At,W=Jt),(Tt!==F||jt!==X||ye!==I||fe!==_t)&&(o.blendFuncSeparate(se[Tt],se[jt],se[ye],se[fe]),F=Tt,X=jt,I=ye,_t=fe),(Ae.equals(z)===!1||Xe!==E)&&(o.blendColor(Ae.r,Ae.g,Ae.b,Xe),z.copy(Ae),E=Xe),P=U,N=!1}function be(U,At){U.side===Pi?Kt(o.CULL_FACE):Gt(o.CULL_FACE);let Tt=U.side===kn;At&&(Tt=!Tt),ce(Tt),U.blending===Es&&U.transparent===!1?Zt(Ha):Zt(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),p.setFunc(U.depthFunc),p.setTest(U.depthTest),p.setMask(U.depthWrite),d.setMask(U.colorWrite);const jt=U.stencilWrite;m.setTest(jt),jt&&(m.setMask(U.stencilWriteMask),m.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),m.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),it(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?Gt(o.SAMPLE_ALPHA_TO_COVERAGE):Kt(o.SAMPLE_ALPHA_TO_COVERAGE)}function ce(U){gt!==U&&(U?o.frontFace(o.CW):o.frontFace(o.CCW),gt=U)}function L(U){U!==Iy?(Gt(o.CULL_FACE),U!==wt&&(U===ug?o.cullFace(o.BACK):U===Hy?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):Kt(o.CULL_FACE),wt=U}function b(U){U!==J&&(at&&o.lineWidth(U),J=U)}function it(U,At,Tt){U?(Gt(o.POLYGON_OFFSET_FILL),(ct!==At||V!==Tt)&&(o.polygonOffset(At,Tt),ct=At,V=Tt)):Kt(o.POLYGON_OFFSET_FILL)}function Pt(U){U?Gt(o.SCISSOR_TEST):Kt(o.SCISSOR_TEST)}function Rt(U){U===void 0&&(U=o.TEXTURE0+lt-1),Q!==U&&(o.activeTexture(U),Q=U)}function q(U,At,Tt){Tt===void 0&&(Q===null?Tt=o.TEXTURE0+lt-1:Tt=Q);let jt=pt[Tt];jt===void 0&&(jt={type:void 0,texture:void 0},pt[Tt]=jt),(jt.type!==U||jt.texture!==At)&&(Q!==Tt&&(o.activeTexture(Tt),Q=Tt),o.bindTexture(U,At||Ht[U]),jt.type=U,jt.texture=At)}function nt(){const U=pt[Q];U!==void 0&&U.type!==void 0&&(o.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function ot(){try{o.compressedTexImage2D.apply(o,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ft(){try{o.compressedTexImage3D.apply(o,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function yt(){try{o.texSubImage2D.apply(o,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Mt(){try{o.texSubImage3D.apply(o,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function rt(){try{o.compressedTexSubImage2D.apply(o,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function le(){try{o.compressedTexSubImage3D.apply(o,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Xt(){try{o.texStorage2D.apply(o,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Lt(){try{o.texStorage3D.apply(o,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Ft(){try{o.texImage2D.apply(o,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function kt(){try{o.texImage3D.apply(o,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Nt(U){ht.equals(U)===!1&&(o.scissor(U.x,U.y,U.z,U.w),ht.copy(U))}function O(U){bt.equals(U)===!1&&(o.viewport(U.x,U.y,U.z,U.w),bt.copy(U))}function mt(U,At){let Tt=y.get(At);Tt===void 0&&(Tt=new WeakMap,y.set(At,Tt));let jt=Tt.get(U);jt===void 0&&(jt=o.getUniformBlockIndex(At,U.name),Tt.set(U,jt))}function Ut(U,At){const jt=y.get(At).get(U);g.get(At)!==jt&&(o.uniformBlockBinding(At,jt,U.__bindingPointIndex),g.set(At,jt))}function zt(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),r===!0&&(o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null)),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),S={},Q=null,pt={},M={},A=new WeakMap,R=[],v=null,_=!1,P=null,D=null,F=null,X=null,W=null,I=null,_t=null,z=new Le(0,0,0),E=0,N=!1,gt=null,wt=null,J=null,ct=null,V=null,ht.set(0,0,o.canvas.width,o.canvas.height),bt.set(0,0,o.canvas.width,o.canvas.height),d.reset(),p.reset(),m.reset()}return{buffers:{color:d,depth:p,stencil:m},enable:Gt,disable:Kt,bindFramebuffer:ae,drawBuffers:et,useProgram:Oe,setBlending:Zt,setMaterial:be,setFlipSided:ce,setCullFace:L,setLineWidth:b,setPolygonOffset:it,setScissorTest:Pt,activeTexture:Rt,bindTexture:q,unbindTexture:nt,compressedTexImage2D:ot,compressedTexImage3D:ft,texImage2D:Ft,texImage3D:kt,updateUBOMapping:mt,uniformBlockBinding:Ut,texStorage2D:Xt,texStorage3D:Lt,texSubImage2D:yt,texSubImage3D:Mt,compressedTexSubImage2D:rt,compressedTexSubImage3D:le,scissor:Nt,viewport:O,reset:zt}}function jb(o,e,i,r,l,u,h){const d=l.isWebGL2,p=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),g=new WeakMap;let y;const S=new WeakMap;let M=!1;try{M=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function A(L,b){return M?new OffscreenCanvas(L,b):Sc("canvas")}function R(L,b,it,Pt){let Rt=1;if((L.width>Pt||L.height>Pt)&&(Rt=Pt/Math.max(L.width,L.height)),Rt<1||b===!0)if(typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&L instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&L instanceof ImageBitmap){const q=b?xc:Math.floor,nt=q(Rt*L.width),ot=q(Rt*L.height);y===void 0&&(y=A(nt,ot));const ft=it?A(nt,ot):y;return ft.width=nt,ft.height=ot,ft.getContext("2d").drawImage(L,0,0,nt,ot),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+L.width+"x"+L.height+") to ("+nt+"x"+ot+")."),ft}else return"data"in L&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+L.width+"x"+L.height+")."),L;return L}function v(L){return Ed(L.width)&&Ed(L.height)}function _(L){return d?!1:L.wrapS!==Ti||L.wrapT!==Ti||L.minFilter!==Fn&&L.minFilter!==Vn}function P(L,b){return L.generateMipmaps&&b&&L.minFilter!==Fn&&L.minFilter!==Vn}function D(L){o.generateMipmap(L)}function F(L,b,it,Pt,Rt=!1){if(d===!1)return b;if(L!==null){if(o[L]!==void 0)return o[L];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+L+"'")}let q=b;if(b===o.RED&&(it===o.FLOAT&&(q=o.R32F),it===o.HALF_FLOAT&&(q=o.R16F),it===o.UNSIGNED_BYTE&&(q=o.R8)),b===o.RED_INTEGER&&(it===o.UNSIGNED_BYTE&&(q=o.R8UI),it===o.UNSIGNED_SHORT&&(q=o.R16UI),it===o.UNSIGNED_INT&&(q=o.R32UI),it===o.BYTE&&(q=o.R8I),it===o.SHORT&&(q=o.R16I),it===o.INT&&(q=o.R32I)),b===o.RG&&(it===o.FLOAT&&(q=o.RG32F),it===o.HALF_FLOAT&&(q=o.RG16F),it===o.UNSIGNED_BYTE&&(q=o.RG8)),b===o.RGBA){const nt=Rt?gc:Ve.getTransfer(Pt);it===o.FLOAT&&(q=o.RGBA32F),it===o.HALF_FLOAT&&(q=o.RGBA16F),it===o.UNSIGNED_BYTE&&(q=nt===Ze?o.SRGB8_ALPHA8:o.RGBA8),it===o.UNSIGNED_SHORT_4_4_4_4&&(q=o.RGBA4),it===o.UNSIGNED_SHORT_5_5_5_1&&(q=o.RGB5_A1)}return(q===o.R16F||q===o.R32F||q===o.RG16F||q===o.RG32F||q===o.RGBA16F||q===o.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function X(L,b,it){return P(L,it)===!0||L.isFramebufferTexture&&L.minFilter!==Fn&&L.minFilter!==Vn?Math.log2(Math.max(b.width,b.height))+1:L.mipmaps!==void 0&&L.mipmaps.length>0?L.mipmaps.length:L.isCompressedTexture&&Array.isArray(L.image)?b.mipmaps.length:1}function W(L){return L===Fn||L===mg||L===Co?o.NEAREST:o.LINEAR}function I(L){const b=L.target;b.removeEventListener("dispose",I),z(b),b.isVideoTexture&&g.delete(b)}function _t(L){const b=L.target;b.removeEventListener("dispose",_t),N(b)}function z(L){const b=r.get(L);if(b.__webglInit===void 0)return;const it=L.source,Pt=S.get(it);if(Pt){const Rt=Pt[b.__cacheKey];Rt.usedTimes--,Rt.usedTimes===0&&E(L),Object.keys(Pt).length===0&&S.delete(it)}r.remove(L)}function E(L){const b=r.get(L);o.deleteTexture(b.__webglTexture);const it=L.source,Pt=S.get(it);delete Pt[b.__cacheKey],h.memory.textures--}function N(L){const b=L.texture,it=r.get(L),Pt=r.get(b);if(Pt.__webglTexture!==void 0&&(o.deleteTexture(Pt.__webglTexture),h.memory.textures--),L.depthTexture&&L.depthTexture.dispose(),L.isWebGLCubeRenderTarget)for(let Rt=0;Rt<6;Rt++){if(Array.isArray(it.__webglFramebuffer[Rt]))for(let q=0;q<it.__webglFramebuffer[Rt].length;q++)o.deleteFramebuffer(it.__webglFramebuffer[Rt][q]);else o.deleteFramebuffer(it.__webglFramebuffer[Rt]);it.__webglDepthbuffer&&o.deleteRenderbuffer(it.__webglDepthbuffer[Rt])}else{if(Array.isArray(it.__webglFramebuffer))for(let Rt=0;Rt<it.__webglFramebuffer.length;Rt++)o.deleteFramebuffer(it.__webglFramebuffer[Rt]);else o.deleteFramebuffer(it.__webglFramebuffer);if(it.__webglDepthbuffer&&o.deleteRenderbuffer(it.__webglDepthbuffer),it.__webglMultisampledFramebuffer&&o.deleteFramebuffer(it.__webglMultisampledFramebuffer),it.__webglColorRenderbuffer)for(let Rt=0;Rt<it.__webglColorRenderbuffer.length;Rt++)it.__webglColorRenderbuffer[Rt]&&o.deleteRenderbuffer(it.__webglColorRenderbuffer[Rt]);it.__webglDepthRenderbuffer&&o.deleteRenderbuffer(it.__webglDepthRenderbuffer)}if(L.isWebGLMultipleRenderTargets)for(let Rt=0,q=b.length;Rt<q;Rt++){const nt=r.get(b[Rt]);nt.__webglTexture&&(o.deleteTexture(nt.__webglTexture),h.memory.textures--),r.remove(b[Rt])}r.remove(b),r.remove(L)}let gt=0;function wt(){gt=0}function J(){const L=gt;return L>=l.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+L+" texture units while this GPU supports only "+l.maxTextures),gt+=1,L}function ct(L){const b=[];return b.push(L.wrapS),b.push(L.wrapT),b.push(L.wrapR||0),b.push(L.magFilter),b.push(L.minFilter),b.push(L.anisotropy),b.push(L.internalFormat),b.push(L.format),b.push(L.type),b.push(L.generateMipmaps),b.push(L.premultiplyAlpha),b.push(L.flipY),b.push(L.unpackAlignment),b.push(L.colorSpace),b.join()}function V(L,b){const it=r.get(L);if(L.isVideoTexture&&be(L),L.isRenderTargetTexture===!1&&L.version>0&&it.__version!==L.version){const Pt=L.image;if(Pt===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Pt.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ht(it,L,b);return}}i.bindTexture(o.TEXTURE_2D,it.__webglTexture,o.TEXTURE0+b)}function lt(L,b){const it=r.get(L);if(L.version>0&&it.__version!==L.version){ht(it,L,b);return}i.bindTexture(o.TEXTURE_2D_ARRAY,it.__webglTexture,o.TEXTURE0+b)}function at(L,b){const it=r.get(L);if(L.version>0&&it.__version!==L.version){ht(it,L,b);return}i.bindTexture(o.TEXTURE_3D,it.__webglTexture,o.TEXTURE0+b)}function dt(L,b){const it=r.get(L);if(L.version>0&&it.__version!==L.version){bt(it,L,b);return}i.bindTexture(o.TEXTURE_CUBE_MAP,it.__webglTexture,o.TEXTURE0+b)}const C={[xd]:o.REPEAT,[Ti]:o.CLAMP_TO_EDGE,[Sd]:o.MIRRORED_REPEAT},Q={[Fn]:o.NEAREST,[mg]:o.NEAREST_MIPMAP_NEAREST,[Co]:o.NEAREST_MIPMAP_LINEAR,[Vn]:o.LINEAR,[Bf]:o.LINEAR_MIPMAP_NEAREST,[_r]:o.LINEAR_MIPMAP_LINEAR},pt={[Cx]:o.NEVER,[Px]:o.ALWAYS,[Dx]:o.LESS,[n0]:o.LEQUAL,[Lx]:o.EQUAL,[Ox]:o.GEQUAL,[Ux]:o.GREATER,[Nx]:o.NOTEQUAL};function Dt(L,b,it){if(b.type===sa&&e.has("OES_texture_float_linear")===!1&&(b.magFilter===Vn||b.magFilter===Bf||b.magFilter===Co||b.magFilter===_r||b.minFilter===Vn||b.minFilter===Bf||b.minFilter===Co||b.minFilter===_r)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),it?(o.texParameteri(L,o.TEXTURE_WRAP_S,C[b.wrapS]),o.texParameteri(L,o.TEXTURE_WRAP_T,C[b.wrapT]),(L===o.TEXTURE_3D||L===o.TEXTURE_2D_ARRAY)&&o.texParameteri(L,o.TEXTURE_WRAP_R,C[b.wrapR]),o.texParameteri(L,o.TEXTURE_MAG_FILTER,Q[b.magFilter]),o.texParameteri(L,o.TEXTURE_MIN_FILTER,Q[b.minFilter])):(o.texParameteri(L,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(L,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),(L===o.TEXTURE_3D||L===o.TEXTURE_2D_ARRAY)&&o.texParameteri(L,o.TEXTURE_WRAP_R,o.CLAMP_TO_EDGE),(b.wrapS!==Ti||b.wrapT!==Ti)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),o.texParameteri(L,o.TEXTURE_MAG_FILTER,W(b.magFilter)),o.texParameteri(L,o.TEXTURE_MIN_FILTER,W(b.minFilter)),b.minFilter!==Fn&&b.minFilter!==Vn&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),b.compareFunction&&(o.texParameteri(L,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(L,o.TEXTURE_COMPARE_FUNC,pt[b.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const Pt=e.get("EXT_texture_filter_anisotropic");if(b.magFilter===Fn||b.minFilter!==Co&&b.minFilter!==_r||b.type===sa&&e.has("OES_texture_float_linear")===!1||d===!1&&b.type===Fo&&e.has("OES_texture_half_float_linear")===!1)return;(b.anisotropy>1||r.get(b).__currentAnisotropy)&&(o.texParameterf(L,Pt.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,l.getMaxAnisotropy())),r.get(b).__currentAnisotropy=b.anisotropy)}}function j(L,b){let it=!1;L.__webglInit===void 0&&(L.__webglInit=!0,b.addEventListener("dispose",I));const Pt=b.source;let Rt=S.get(Pt);Rt===void 0&&(Rt={},S.set(Pt,Rt));const q=ct(b);if(q!==L.__cacheKey){Rt[q]===void 0&&(Rt[q]={texture:o.createTexture(),usedTimes:0},h.memory.textures++,it=!0),Rt[q].usedTimes++;const nt=Rt[L.__cacheKey];nt!==void 0&&(Rt[L.__cacheKey].usedTimes--,nt.usedTimes===0&&E(b)),L.__cacheKey=q,L.__webglTexture=Rt[q].texture}return it}function ht(L,b,it){let Pt=o.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(Pt=o.TEXTURE_2D_ARRAY),b.isData3DTexture&&(Pt=o.TEXTURE_3D);const Rt=j(L,b),q=b.source;i.bindTexture(Pt,L.__webglTexture,o.TEXTURE0+it);const nt=r.get(q);if(q.version!==nt.__version||Rt===!0){i.activeTexture(o.TEXTURE0+it);const ot=Ve.getPrimaries(Ve.workingColorSpace),ft=b.colorSpace===hi?null:Ve.getPrimaries(b.colorSpace),yt=b.colorSpace===hi||ot===ft?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,b.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,b.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,yt);const Mt=_(b)&&v(b.image)===!1;let rt=R(b.image,Mt,!1,l.maxTextureSize);rt=ce(b,rt);const le=v(rt)||d,Xt=u.convert(b.format,b.colorSpace);let Lt=u.convert(b.type),Ft=F(b.internalFormat,Xt,Lt,b.colorSpace,b.isVideoTexture);Dt(Pt,b,le);let kt;const Nt=b.mipmaps,O=d&&b.isVideoTexture!==!0&&Ft!==$_,mt=nt.__version===void 0||Rt===!0,Ut=q.dataReady,zt=X(b,rt,le);if(b.isDepthTexture)Ft=o.DEPTH_COMPONENT,d?b.type===sa?Ft=o.DEPTH_COMPONENT32F:b.type===Ia?Ft=o.DEPTH_COMPONENT24:b.type===vr?Ft=o.DEPTH24_STENCIL8:Ft=o.DEPTH_COMPONENT16:b.type===sa&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),b.format===yr&&Ft===o.DEPTH_COMPONENT&&b.type!==Rd&&b.type!==Ia&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),b.type=Ia,Lt=u.convert(b.type)),b.format===Rs&&Ft===o.DEPTH_COMPONENT&&(Ft=o.DEPTH_STENCIL,b.type!==vr&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),b.type=vr,Lt=u.convert(b.type))),mt&&(O?i.texStorage2D(o.TEXTURE_2D,1,Ft,rt.width,rt.height):i.texImage2D(o.TEXTURE_2D,0,Ft,rt.width,rt.height,0,Xt,Lt,null));else if(b.isDataTexture)if(Nt.length>0&&le){O&&mt&&i.texStorage2D(o.TEXTURE_2D,zt,Ft,Nt[0].width,Nt[0].height);for(let U=0,At=Nt.length;U<At;U++)kt=Nt[U],O?Ut&&i.texSubImage2D(o.TEXTURE_2D,U,0,0,kt.width,kt.height,Xt,Lt,kt.data):i.texImage2D(o.TEXTURE_2D,U,Ft,kt.width,kt.height,0,Xt,Lt,kt.data);b.generateMipmaps=!1}else O?(mt&&i.texStorage2D(o.TEXTURE_2D,zt,Ft,rt.width,rt.height),Ut&&i.texSubImage2D(o.TEXTURE_2D,0,0,0,rt.width,rt.height,Xt,Lt,rt.data)):i.texImage2D(o.TEXTURE_2D,0,Ft,rt.width,rt.height,0,Xt,Lt,rt.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){O&&mt&&i.texStorage3D(o.TEXTURE_2D_ARRAY,zt,Ft,Nt[0].width,Nt[0].height,rt.depth);for(let U=0,At=Nt.length;U<At;U++)kt=Nt[U],b.format!==bi?Xt!==null?O?Ut&&i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,U,0,0,0,kt.width,kt.height,rt.depth,Xt,kt.data,0,0):i.compressedTexImage3D(o.TEXTURE_2D_ARRAY,U,Ft,kt.width,kt.height,rt.depth,0,kt.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):O?Ut&&i.texSubImage3D(o.TEXTURE_2D_ARRAY,U,0,0,0,kt.width,kt.height,rt.depth,Xt,Lt,kt.data):i.texImage3D(o.TEXTURE_2D_ARRAY,U,Ft,kt.width,kt.height,rt.depth,0,Xt,Lt,kt.data)}else{O&&mt&&i.texStorage2D(o.TEXTURE_2D,zt,Ft,Nt[0].width,Nt[0].height);for(let U=0,At=Nt.length;U<At;U++)kt=Nt[U],b.format!==bi?Xt!==null?O?Ut&&i.compressedTexSubImage2D(o.TEXTURE_2D,U,0,0,kt.width,kt.height,Xt,kt.data):i.compressedTexImage2D(o.TEXTURE_2D,U,Ft,kt.width,kt.height,0,kt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):O?Ut&&i.texSubImage2D(o.TEXTURE_2D,U,0,0,kt.width,kt.height,Xt,Lt,kt.data):i.texImage2D(o.TEXTURE_2D,U,Ft,kt.width,kt.height,0,Xt,Lt,kt.data)}else if(b.isDataArrayTexture)O?(mt&&i.texStorage3D(o.TEXTURE_2D_ARRAY,zt,Ft,rt.width,rt.height,rt.depth),Ut&&i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,rt.width,rt.height,rt.depth,Xt,Lt,rt.data)):i.texImage3D(o.TEXTURE_2D_ARRAY,0,Ft,rt.width,rt.height,rt.depth,0,Xt,Lt,rt.data);else if(b.isData3DTexture)O?(mt&&i.texStorage3D(o.TEXTURE_3D,zt,Ft,rt.width,rt.height,rt.depth),Ut&&i.texSubImage3D(o.TEXTURE_3D,0,0,0,0,rt.width,rt.height,rt.depth,Xt,Lt,rt.data)):i.texImage3D(o.TEXTURE_3D,0,Ft,rt.width,rt.height,rt.depth,0,Xt,Lt,rt.data);else if(b.isFramebufferTexture){if(mt)if(O)i.texStorage2D(o.TEXTURE_2D,zt,Ft,rt.width,rt.height);else{let U=rt.width,At=rt.height;for(let Tt=0;Tt<zt;Tt++)i.texImage2D(o.TEXTURE_2D,Tt,Ft,U,At,0,Xt,Lt,null),U>>=1,At>>=1}}else if(Nt.length>0&&le){O&&mt&&i.texStorage2D(o.TEXTURE_2D,zt,Ft,Nt[0].width,Nt[0].height);for(let U=0,At=Nt.length;U<At;U++)kt=Nt[U],O?Ut&&i.texSubImage2D(o.TEXTURE_2D,U,0,0,Xt,Lt,kt):i.texImage2D(o.TEXTURE_2D,U,Ft,Xt,Lt,kt);b.generateMipmaps=!1}else O?(mt&&i.texStorage2D(o.TEXTURE_2D,zt,Ft,rt.width,rt.height),Ut&&i.texSubImage2D(o.TEXTURE_2D,0,0,0,Xt,Lt,rt)):i.texImage2D(o.TEXTURE_2D,0,Ft,Xt,Lt,rt);P(b,le)&&D(Pt),nt.__version=q.version,b.onUpdate&&b.onUpdate(b)}L.__version=b.version}function bt(L,b,it){if(b.image.length!==6)return;const Pt=j(L,b),Rt=b.source;i.bindTexture(o.TEXTURE_CUBE_MAP,L.__webglTexture,o.TEXTURE0+it);const q=r.get(Rt);if(Rt.version!==q.__version||Pt===!0){i.activeTexture(o.TEXTURE0+it);const nt=Ve.getPrimaries(Ve.workingColorSpace),ot=b.colorSpace===hi?null:Ve.getPrimaries(b.colorSpace),ft=b.colorSpace===hi||nt===ot?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,b.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,b.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,ft);const yt=b.isCompressedTexture||b.image[0].isCompressedTexture,Mt=b.image[0]&&b.image[0].isDataTexture,rt=[];for(let U=0;U<6;U++)!yt&&!Mt?rt[U]=R(b.image[U],!1,!0,l.maxCubemapSize):rt[U]=Mt?b.image[U].image:b.image[U],rt[U]=ce(b,rt[U]);const le=rt[0],Xt=v(le)||d,Lt=u.convert(b.format,b.colorSpace),Ft=u.convert(b.type),kt=F(b.internalFormat,Lt,Ft,b.colorSpace),Nt=d&&b.isVideoTexture!==!0,O=q.__version===void 0||Pt===!0,mt=Rt.dataReady;let Ut=X(b,le,Xt);Dt(o.TEXTURE_CUBE_MAP,b,Xt);let zt;if(yt){Nt&&O&&i.texStorage2D(o.TEXTURE_CUBE_MAP,Ut,kt,le.width,le.height);for(let U=0;U<6;U++){zt=rt[U].mipmaps;for(let At=0;At<zt.length;At++){const Tt=zt[At];b.format!==bi?Lt!==null?Nt?mt&&i.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+U,At,0,0,Tt.width,Tt.height,Lt,Tt.data):i.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+U,At,kt,Tt.width,Tt.height,0,Tt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Nt?mt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+U,At,0,0,Tt.width,Tt.height,Lt,Ft,Tt.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+U,At,kt,Tt.width,Tt.height,0,Lt,Ft,Tt.data)}}}else{zt=b.mipmaps,Nt&&O&&(zt.length>0&&Ut++,i.texStorage2D(o.TEXTURE_CUBE_MAP,Ut,kt,rt[0].width,rt[0].height));for(let U=0;U<6;U++)if(Mt){Nt?mt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+U,0,0,0,rt[U].width,rt[U].height,Lt,Ft,rt[U].data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+U,0,kt,rt[U].width,rt[U].height,0,Lt,Ft,rt[U].data);for(let At=0;At<zt.length;At++){const jt=zt[At].image[U].image;Nt?mt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+U,At+1,0,0,jt.width,jt.height,Lt,Ft,jt.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+U,At+1,kt,jt.width,jt.height,0,Lt,Ft,jt.data)}}else{Nt?mt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+U,0,0,0,Lt,Ft,rt[U]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+U,0,kt,Lt,Ft,rt[U]);for(let At=0;At<zt.length;At++){const Tt=zt[At];Nt?mt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+U,At+1,0,0,Lt,Ft,Tt.image[U]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+U,At+1,kt,Lt,Ft,Tt.image[U])}}}P(b,Xt)&&D(o.TEXTURE_CUBE_MAP),q.__version=Rt.version,b.onUpdate&&b.onUpdate(b)}L.__version=b.version}function Yt(L,b,it,Pt,Rt,q){const nt=u.convert(it.format,it.colorSpace),ot=u.convert(it.type),ft=F(it.internalFormat,nt,ot,it.colorSpace);if(!r.get(b).__hasExternalTextures){const Mt=Math.max(1,b.width>>q),rt=Math.max(1,b.height>>q);Rt===o.TEXTURE_3D||Rt===o.TEXTURE_2D_ARRAY?i.texImage3D(Rt,q,ft,Mt,rt,b.depth,0,nt,ot,null):i.texImage2D(Rt,q,ft,Mt,rt,0,nt,ot,null)}i.bindFramebuffer(o.FRAMEBUFFER,L),Zt(b)?p.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,Pt,Rt,r.get(it).__webglTexture,0,se(b)):(Rt===o.TEXTURE_2D||Rt>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&Rt<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,Pt,Rt,r.get(it).__webglTexture,q),i.bindFramebuffer(o.FRAMEBUFFER,null)}function Ht(L,b,it){if(o.bindRenderbuffer(o.RENDERBUFFER,L),b.depthBuffer&&!b.stencilBuffer){let Pt=d===!0?o.DEPTH_COMPONENT24:o.DEPTH_COMPONENT16;if(it||Zt(b)){const Rt=b.depthTexture;Rt&&Rt.isDepthTexture&&(Rt.type===sa?Pt=o.DEPTH_COMPONENT32F:Rt.type===Ia&&(Pt=o.DEPTH_COMPONENT24));const q=se(b);Zt(b)?p.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,q,Pt,b.width,b.height):o.renderbufferStorageMultisample(o.RENDERBUFFER,q,Pt,b.width,b.height)}else o.renderbufferStorage(o.RENDERBUFFER,Pt,b.width,b.height);o.framebufferRenderbuffer(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.RENDERBUFFER,L)}else if(b.depthBuffer&&b.stencilBuffer){const Pt=se(b);it&&Zt(b)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,Pt,o.DEPTH24_STENCIL8,b.width,b.height):Zt(b)?p.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,Pt,o.DEPTH24_STENCIL8,b.width,b.height):o.renderbufferStorage(o.RENDERBUFFER,o.DEPTH_STENCIL,b.width,b.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.RENDERBUFFER,L)}else{const Pt=b.isWebGLMultipleRenderTargets===!0?b.texture:[b.texture];for(let Rt=0;Rt<Pt.length;Rt++){const q=Pt[Rt],nt=u.convert(q.format,q.colorSpace),ot=u.convert(q.type),ft=F(q.internalFormat,nt,ot,q.colorSpace),yt=se(b);it&&Zt(b)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,yt,ft,b.width,b.height):Zt(b)?p.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,yt,ft,b.width,b.height):o.renderbufferStorage(o.RENDERBUFFER,ft,b.width,b.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function Gt(L,b){if(b&&b.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(o.FRAMEBUFFER,L),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!r.get(b.depthTexture).__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),V(b.depthTexture,0);const Pt=r.get(b.depthTexture).__webglTexture,Rt=se(b);if(b.depthTexture.format===yr)Zt(b)?p.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,Pt,0,Rt):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,Pt,0);else if(b.depthTexture.format===Rs)Zt(b)?p.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,Pt,0,Rt):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,Pt,0);else throw new Error("Unknown depthTexture format")}function Kt(L){const b=r.get(L),it=L.isWebGLCubeRenderTarget===!0;if(L.depthTexture&&!b.__autoAllocateDepthBuffer){if(it)throw new Error("target.depthTexture not supported in Cube render targets");Gt(b.__webglFramebuffer,L)}else if(it){b.__webglDepthbuffer=[];for(let Pt=0;Pt<6;Pt++)i.bindFramebuffer(o.FRAMEBUFFER,b.__webglFramebuffer[Pt]),b.__webglDepthbuffer[Pt]=o.createRenderbuffer(),Ht(b.__webglDepthbuffer[Pt],L,!1)}else i.bindFramebuffer(o.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer=o.createRenderbuffer(),Ht(b.__webglDepthbuffer,L,!1);i.bindFramebuffer(o.FRAMEBUFFER,null)}function ae(L,b,it){const Pt=r.get(L);b!==void 0&&Yt(Pt.__webglFramebuffer,L,L.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),it!==void 0&&Kt(L)}function et(L){const b=L.texture,it=r.get(L),Pt=r.get(b);L.addEventListener("dispose",_t),L.isWebGLMultipleRenderTargets!==!0&&(Pt.__webglTexture===void 0&&(Pt.__webglTexture=o.createTexture()),Pt.__version=b.version,h.memory.textures++);const Rt=L.isWebGLCubeRenderTarget===!0,q=L.isWebGLMultipleRenderTargets===!0,nt=v(L)||d;if(Rt){it.__webglFramebuffer=[];for(let ot=0;ot<6;ot++)if(d&&b.mipmaps&&b.mipmaps.length>0){it.__webglFramebuffer[ot]=[];for(let ft=0;ft<b.mipmaps.length;ft++)it.__webglFramebuffer[ot][ft]=o.createFramebuffer()}else it.__webglFramebuffer[ot]=o.createFramebuffer()}else{if(d&&b.mipmaps&&b.mipmaps.length>0){it.__webglFramebuffer=[];for(let ot=0;ot<b.mipmaps.length;ot++)it.__webglFramebuffer[ot]=o.createFramebuffer()}else it.__webglFramebuffer=o.createFramebuffer();if(q)if(l.drawBuffers){const ot=L.texture;for(let ft=0,yt=ot.length;ft<yt;ft++){const Mt=r.get(ot[ft]);Mt.__webglTexture===void 0&&(Mt.__webglTexture=o.createTexture(),h.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(d&&L.samples>0&&Zt(L)===!1){const ot=q?b:[b];it.__webglMultisampledFramebuffer=o.createFramebuffer(),it.__webglColorRenderbuffer=[],i.bindFramebuffer(o.FRAMEBUFFER,it.__webglMultisampledFramebuffer);for(let ft=0;ft<ot.length;ft++){const yt=ot[ft];it.__webglColorRenderbuffer[ft]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,it.__webglColorRenderbuffer[ft]);const Mt=u.convert(yt.format,yt.colorSpace),rt=u.convert(yt.type),le=F(yt.internalFormat,Mt,rt,yt.colorSpace,L.isXRRenderTarget===!0),Xt=se(L);o.renderbufferStorageMultisample(o.RENDERBUFFER,Xt,le,L.width,L.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+ft,o.RENDERBUFFER,it.__webglColorRenderbuffer[ft])}o.bindRenderbuffer(o.RENDERBUFFER,null),L.depthBuffer&&(it.__webglDepthRenderbuffer=o.createRenderbuffer(),Ht(it.__webglDepthRenderbuffer,L,!0)),i.bindFramebuffer(o.FRAMEBUFFER,null)}}if(Rt){i.bindTexture(o.TEXTURE_CUBE_MAP,Pt.__webglTexture),Dt(o.TEXTURE_CUBE_MAP,b,nt);for(let ot=0;ot<6;ot++)if(d&&b.mipmaps&&b.mipmaps.length>0)for(let ft=0;ft<b.mipmaps.length;ft++)Yt(it.__webglFramebuffer[ot][ft],L,b,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+ot,ft);else Yt(it.__webglFramebuffer[ot],L,b,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0);P(b,nt)&&D(o.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(q){const ot=L.texture;for(let ft=0,yt=ot.length;ft<yt;ft++){const Mt=ot[ft],rt=r.get(Mt);i.bindTexture(o.TEXTURE_2D,rt.__webglTexture),Dt(o.TEXTURE_2D,Mt,nt),Yt(it.__webglFramebuffer,L,Mt,o.COLOR_ATTACHMENT0+ft,o.TEXTURE_2D,0),P(Mt,nt)&&D(o.TEXTURE_2D)}i.unbindTexture()}else{let ot=o.TEXTURE_2D;if((L.isWebGL3DRenderTarget||L.isWebGLArrayRenderTarget)&&(d?ot=L.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),i.bindTexture(ot,Pt.__webglTexture),Dt(ot,b,nt),d&&b.mipmaps&&b.mipmaps.length>0)for(let ft=0;ft<b.mipmaps.length;ft++)Yt(it.__webglFramebuffer[ft],L,b,o.COLOR_ATTACHMENT0,ot,ft);else Yt(it.__webglFramebuffer,L,b,o.COLOR_ATTACHMENT0,ot,0);P(b,nt)&&D(ot),i.unbindTexture()}L.depthBuffer&&Kt(L)}function Oe(L){const b=v(L)||d,it=L.isWebGLMultipleRenderTargets===!0?L.texture:[L.texture];for(let Pt=0,Rt=it.length;Pt<Rt;Pt++){const q=it[Pt];if(P(q,b)){const nt=L.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:o.TEXTURE_2D,ot=r.get(q).__webglTexture;i.bindTexture(nt,ot),D(nt),i.unbindTexture()}}}function ne(L){if(d&&L.samples>0&&Zt(L)===!1){const b=L.isWebGLMultipleRenderTargets?L.texture:[L.texture],it=L.width,Pt=L.height;let Rt=o.COLOR_BUFFER_BIT;const q=[],nt=L.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ot=r.get(L),ft=L.isWebGLMultipleRenderTargets===!0;if(ft)for(let yt=0;yt<b.length;yt++)i.bindFramebuffer(o.FRAMEBUFFER,ot.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+yt,o.RENDERBUFFER,null),i.bindFramebuffer(o.FRAMEBUFFER,ot.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+yt,o.TEXTURE_2D,null,0);i.bindFramebuffer(o.READ_FRAMEBUFFER,ot.__webglMultisampledFramebuffer),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,ot.__webglFramebuffer);for(let yt=0;yt<b.length;yt++){q.push(o.COLOR_ATTACHMENT0+yt),L.depthBuffer&&q.push(nt);const Mt=ot.__ignoreDepthValues!==void 0?ot.__ignoreDepthValues:!1;if(Mt===!1&&(L.depthBuffer&&(Rt|=o.DEPTH_BUFFER_BIT),L.stencilBuffer&&(Rt|=o.STENCIL_BUFFER_BIT)),ft&&o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,ot.__webglColorRenderbuffer[yt]),Mt===!0&&(o.invalidateFramebuffer(o.READ_FRAMEBUFFER,[nt]),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[nt])),ft){const rt=r.get(b[yt]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,rt,0)}o.blitFramebuffer(0,0,it,Pt,0,0,it,Pt,Rt,o.NEAREST),m&&o.invalidateFramebuffer(o.READ_FRAMEBUFFER,q)}if(i.bindFramebuffer(o.READ_FRAMEBUFFER,null),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),ft)for(let yt=0;yt<b.length;yt++){i.bindFramebuffer(o.FRAMEBUFFER,ot.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+yt,o.RENDERBUFFER,ot.__webglColorRenderbuffer[yt]);const Mt=r.get(b[yt]).__webglTexture;i.bindFramebuffer(o.FRAMEBUFFER,ot.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+yt,o.TEXTURE_2D,Mt,0)}i.bindFramebuffer(o.DRAW_FRAMEBUFFER,ot.__webglMultisampledFramebuffer)}}function se(L){return Math.min(l.maxSamples,L.samples)}function Zt(L){const b=r.get(L);return d&&L.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function be(L){const b=h.render.frame;g.get(L)!==b&&(g.set(L,b),L.update())}function ce(L,b){const it=L.colorSpace,Pt=L.format,Rt=L.type;return L.isCompressedTexture===!0||L.isVideoTexture===!0||L.format===Md||it!==la&&it!==hi&&(Ve.getTransfer(it)===Ze?d===!1?e.has("EXT_sRGB")===!0&&Pt===bi?(L.format=Md,L.minFilter=Vn,L.generateMipmaps=!1):b=a0.sRGBToLinear(b):(Pt!==bi||Rt!==Va)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",it)),b}this.allocateTextureUnit=J,this.resetTextureUnits=wt,this.setTexture2D=V,this.setTexture2DArray=lt,this.setTexture3D=at,this.setTextureCube=dt,this.rebindTextures=ae,this.setupRenderTarget=et,this.updateRenderTargetMipmap=Oe,this.updateMultisampleRenderTarget=ne,this.setupDepthRenderbuffer=Kt,this.setupFrameBufferTexture=Yt,this.useMultisampledRTT=Zt}function Zb(o,e,i){const r=i.isWebGL2;function l(u,h=hi){let d;const p=Ve.getTransfer(h);if(u===Va)return o.UNSIGNED_BYTE;if(u===j_)return o.UNSIGNED_SHORT_4_4_4_4;if(u===Z_)return o.UNSIGNED_SHORT_5_5_5_1;if(u===vx)return o.BYTE;if(u===yx)return o.SHORT;if(u===Rd)return o.UNSIGNED_SHORT;if(u===Y_)return o.INT;if(u===Ia)return o.UNSIGNED_INT;if(u===sa)return o.FLOAT;if(u===Fo)return r?o.HALF_FLOAT:(d=e.get("OES_texture_half_float"),d!==null?d.HALF_FLOAT_OES:null);if(u===xx)return o.ALPHA;if(u===bi)return o.RGBA;if(u===Sx)return o.LUMINANCE;if(u===Mx)return o.LUMINANCE_ALPHA;if(u===yr)return o.DEPTH_COMPONENT;if(u===Rs)return o.DEPTH_STENCIL;if(u===Md)return d=e.get("EXT_sRGB"),d!==null?d.SRGB_ALPHA_EXT:null;if(u===Ex)return o.RED;if(u===K_)return o.RED_INTEGER;if(u===Tx)return o.RG;if(u===Q_)return o.RG_INTEGER;if(u===J_)return o.RGBA_INTEGER;if(u===Ff||u===If||u===Hf||u===Gf)if(p===Ze)if(d=e.get("WEBGL_compressed_texture_s3tc_srgb"),d!==null){if(u===Ff)return d.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(u===If)return d.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(u===Hf)return d.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(u===Gf)return d.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(d=e.get("WEBGL_compressed_texture_s3tc"),d!==null){if(u===Ff)return d.COMPRESSED_RGB_S3TC_DXT1_EXT;if(u===If)return d.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(u===Hf)return d.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(u===Gf)return d.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(u===gg||u===_g||u===vg||u===yg)if(d=e.get("WEBGL_compressed_texture_pvrtc"),d!==null){if(u===gg)return d.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(u===_g)return d.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(u===vg)return d.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(u===yg)return d.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(u===$_)return d=e.get("WEBGL_compressed_texture_etc1"),d!==null?d.COMPRESSED_RGB_ETC1_WEBGL:null;if(u===xg||u===Sg)if(d=e.get("WEBGL_compressed_texture_etc"),d!==null){if(u===xg)return p===Ze?d.COMPRESSED_SRGB8_ETC2:d.COMPRESSED_RGB8_ETC2;if(u===Sg)return p===Ze?d.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:d.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(u===Mg||u===Eg||u===Tg||u===bg||u===Ag||u===wg||u===Rg||u===Cg||u===Dg||u===Lg||u===Ug||u===Ng||u===Og||u===Pg)if(d=e.get("WEBGL_compressed_texture_astc"),d!==null){if(u===Mg)return p===Ze?d.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:d.COMPRESSED_RGBA_ASTC_4x4_KHR;if(u===Eg)return p===Ze?d.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:d.COMPRESSED_RGBA_ASTC_5x4_KHR;if(u===Tg)return p===Ze?d.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:d.COMPRESSED_RGBA_ASTC_5x5_KHR;if(u===bg)return p===Ze?d.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:d.COMPRESSED_RGBA_ASTC_6x5_KHR;if(u===Ag)return p===Ze?d.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:d.COMPRESSED_RGBA_ASTC_6x6_KHR;if(u===wg)return p===Ze?d.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:d.COMPRESSED_RGBA_ASTC_8x5_KHR;if(u===Rg)return p===Ze?d.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:d.COMPRESSED_RGBA_ASTC_8x6_KHR;if(u===Cg)return p===Ze?d.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:d.COMPRESSED_RGBA_ASTC_8x8_KHR;if(u===Dg)return p===Ze?d.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:d.COMPRESSED_RGBA_ASTC_10x5_KHR;if(u===Lg)return p===Ze?d.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:d.COMPRESSED_RGBA_ASTC_10x6_KHR;if(u===Ug)return p===Ze?d.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:d.COMPRESSED_RGBA_ASTC_10x8_KHR;if(u===Ng)return p===Ze?d.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:d.COMPRESSED_RGBA_ASTC_10x10_KHR;if(u===Og)return p===Ze?d.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:d.COMPRESSED_RGBA_ASTC_12x10_KHR;if(u===Pg)return p===Ze?d.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:d.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(u===Vf||u===zg||u===Bg)if(d=e.get("EXT_texture_compression_bptc"),d!==null){if(u===Vf)return p===Ze?d.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:d.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(u===zg)return d.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(u===Bg)return d.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(u===bx||u===Fg||u===Ig||u===Hg)if(d=e.get("EXT_texture_compression_rgtc"),d!==null){if(u===Vf)return d.COMPRESSED_RED_RGTC1_EXT;if(u===Fg)return d.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(u===Ig)return d.COMPRESSED_RED_GREEN_RGTC2_EXT;if(u===Hg)return d.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return u===vr?r?o.UNSIGNED_INT_24_8:(d=e.get("WEBGL_depth_texture"),d!==null?d.UNSIGNED_INT_24_8_WEBGL:null):o[u]!==void 0?o[u]:null}return{convert:l}}class Kb extends Jn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Po extends An{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Qb={type:"move"};class fd{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Po,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Po,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new Z,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new Z),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Po,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new Z,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new Z),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const i=this._hand;if(i)for(const r of e.hand.values())this._getHandJoint(i,r)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,i,r){let l=null,u=null,h=null;const d=this._targetRay,p=this._grip,m=this._hand;if(e&&i.session.visibilityState!=="visible-blurred"){if(m&&e.hand){h=!0;for(const R of e.hand.values()){const v=i.getJointPose(R,r),_=this._getHandJoint(m,R);v!==null&&(_.matrix.fromArray(v.transform.matrix),_.matrix.decompose(_.position,_.rotation,_.scale),_.matrixWorldNeedsUpdate=!0,_.jointRadius=v.radius),_.visible=v!==null}const g=m.joints["index-finger-tip"],y=m.joints["thumb-tip"],S=g.position.distanceTo(y.position),M=.02,A=.005;m.inputState.pinching&&S>M+A?(m.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!m.inputState.pinching&&S<=M-A&&(m.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else p!==null&&e.gripSpace&&(u=i.getPose(e.gripSpace,r),u!==null&&(p.matrix.fromArray(u.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,u.linearVelocity?(p.hasLinearVelocity=!0,p.linearVelocity.copy(u.linearVelocity)):p.hasLinearVelocity=!1,u.angularVelocity?(p.hasAngularVelocity=!0,p.angularVelocity.copy(u.angularVelocity)):p.hasAngularVelocity=!1));d!==null&&(l=i.getPose(e.targetRaySpace,r),l===null&&u!==null&&(l=u),l!==null&&(d.matrix.fromArray(l.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,l.linearVelocity?(d.hasLinearVelocity=!0,d.linearVelocity.copy(l.linearVelocity)):d.hasLinearVelocity=!1,l.angularVelocity?(d.hasAngularVelocity=!0,d.angularVelocity.copy(l.angularVelocity)):d.hasAngularVelocity=!1,this.dispatchEvent(Qb)))}return d!==null&&(d.visible=l!==null),p!==null&&(p.visible=u!==null),m!==null&&(m.visible=h!==null),this}_getHandJoint(e,i){if(e.joints[i.jointName]===void 0){const r=new Po;r.matrixAutoUpdate=!1,r.visible=!1,e.joints[i.jointName]=r,e.add(r)}return e.joints[i.jointName]}}const Jb=`
void main() {
